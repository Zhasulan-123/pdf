parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    XvCm: [
      function (require, module, exports) {
        module.exports = (o, t) =>
          `${o}-${t}-${Math.random().toString(16).slice(3, 8)}`;
      },
      {},
    ],
    uXW0: [
      function (require, module, exports) {
        ...
        module.exports = ({ id: e, action: d, payload: i = {} }) => {
          let a = e;
          return (
            void 0 === a && ((a = o("Job", t)), (t += 1)),
            { id: a, action: d, payload: i }
          );
        };
      },
      { "./utils/getId": "XvCm" },
    ...
    eMFN: [
      function (require, module, exports) {
        const e = require("./createJob"),
          { log: t } = require("./utils/log"),
          r = require("./utils/getId");
        let o = 0;
        module.exports = () => {
          const i = r("Scheduler", o),
            n = {},
            a = {};
          let d = [];
          o += 1;
            ...
            u = (r, o) =>
              new Promise((n, s) => {
                ...
                d.push(async (e) => {
                  ...
                  t(`[${i}]: Add ${u.id} to JobQueue`),
                  t(`[${i}]: JobQueue length=${d.length}`),
                  l();
              });
          return {
            addWorker: (e) => (
            ...
            addJob: async (e, ...t) => {
              if (0 === s())
                throw Error(
                  `[${i}]: You need to have at least one worker before adding jobs`
                );
              return u(e, t);
            },
            terminate: async () => {
        ...
        !(function (r, t) {
          ...
          return function () {
            ...
            for (var n, o = document.createElement("a"), a = 1; a < e; a++)
              (o.href = arguments[a]), (n = o.href), (r.href = n);
    ...
    EDO9: [
      function (require, module, exports) {
        const r = "browser" === require("./getEnvironment")("type"),
          e = r ? require("resolve-url") : (r) => r;
        module.exports = (r) => {
          const o = { ...r };
          return (
        ...
        module.exports = {
          _args: [
            [
              ...
              "C:\\Users\\catinweb\\Documents\\XXX\\tesseract",
            ],
          ],
          ...
          _inBundle: !1,
          _integrity:
            "sha512-vbBqWOzr2UNrac8vhtwvsMABumwhLw8ILdWRp0XqcwVYrc8Ay6IDG9/riq16XQF0uETwcbuACSv3JEj2bYfDhA==",
          ...
          _requiredBy: ["/"],
          _resolved:
            "https://registry.npmjs.org/tesseract.js/-/tesseract.js-2.0.0-beta.2.tgz",
          _spec: "2.0.0-beta.2",
    ...
    I5Ld: [
      function (require, module, exports) {
        ...
        const s = require("resolve-url"),
          { version: r, dependencies: t } = require("../../../package.json"),
          o = require("../../constants/defaultOptions");
        module.exports = {
          ...o,
          workerPath: `https://unpkg.com/tesseract.js@v${r}/dist/worker.min.js`,
          corePath: `https://unpkg.com/tesseract.js-core@v${t[
            "tesseract.js-core"
          ].substring(1)}/tesseract-core.${
            "object" == typeof WebAssembly ? "wasm" : "asm"
          }.js`,
        };
      },
      {
      ...
      function (require, module, exports) {
        const e = require("axios"),
          ...
          t = async (o) => {
            ...
            if ("string" == typeof o)
              if (/data:image\/([a-zA-Z]*);base64,([^"]*)/.test(o))
                i = atob(o.split(",")[1])
                  .split("")
                  .map((e) => e.charCodeAt(0));
              else {
                const { data: r } = await e.get(a(o), {
              ...
              o instanceof HTMLElement
                ? ("IMG" === o.tagName && (i = await t(o.src)),
                  "VIDEO" === o.tagName && (i = await t(o.poster)),
                  "CANVAS" === o.tagName &&
                    (await new Promise((e) => {
                      o.toBlob(async (a) => {
                        (i = await r(a)), e();
    ...
    f6pb: [
      function (require, module, exports) {
        const e = require("./defaultOptions"),
          r = require("./spawnWorker"),
          o = require("./terminateWorker"),
          a = require("./onMessage"),
          s = require("./send"),
          n = require("./loadImage");
        module.exports = {
    ...
    Fqzj: [
      function (require, module, exports) {
        const e = require("./utils/resolvePaths"),
          a = require("./utils/circularize"),
          t = require("./createJob"),
          { log: o } = require("./utils/log"),
          i = require("./utils/getId"),
          { defaultOEM: r } = require("./constants/config"),
          {
            defaultOptions: n,
            spawnWorker: l,
            terminateWorker: s,
        ...
        module.exports = (p = {}) => {
          ...
          const I = (e, a) => {
            ...
            j = ({ id: e, action: a, payload: t }) =>
              new Promise((i, r) => {
                o(`[${m}]: Start ${e}, action=${a}`),
                  I(a, i),
                  f(a, r),
                  g(q, { workerId: m, jobId: e, action: a, payload: t });
              });
          return (
            d(q, ({ workerId: e, jobId: t, status: i, action: r, data: n }) => {
              if ("resolve" === i) {
                o(`[${e}]: Complete ${t}`);
                let i = n;
                "recognize" === r
                  ? (i = a(n))
                  : "getPDF" === r &&
                    (i = Array.from({ ...n, length: Object.keys(n).length })),
                  k[r]({ jobId: t, data: i });
              } else {
            ...
            }),
            {
              ...
              setReject: f,
              load: (e) =>
                j(t({ id: e, action: "load", payload: { options: w } })),
              loadLanguage: (e = "eng", a) =>
                j(
                  t({
                    id: a,
                    action: "loadLanguage",
                    payload: { langs: e, options: w },
                  })
                ),
              initialize: (e = "eng", a = r, o) =>
                j(
                  t({
                    id: o,
                    action: "initialize",
                    payload: { langs: e, oem: a },
                  })
                ),
              setParameters: (e = {}, a) =>
                j(
                  t({ id: a, action: "setParameters", payload: { params: e } })
                ),
              recognize: async (e, a = {}, o) =>
                j(
                  t({
                    id: o,
                    action: "recognize",
              ...
              getPDF: (e = "Tesseract OCR Result", a = !1, o) =>
                j(
                  t({
                    id: o,
                    action: "getPDF",
              ...
              detect: async (e, a) =>
                j(
                  t({ id: a, action: "detect", payload: { image: await c(e) } })
                ),
              terminate: async (e) => (
                null !== q &&
                  (await j(t({ id: e, action: "terminate" })),
                  s(q),
                  (q = null)),
                Promise.resolve()
              ),
    ...
    XgES: [
      function (require, module, exports) {
        const a = require("./createWorker"),
          e = async (e, t, i) => {
            const n = a(i);
            return (
              await n.load(),
              await n.loadLanguage(t),
              await n.initialize(t),
              n.recognize(e).finally(async () => {
                await n.terminate();
              })
            );
          },
          t = async (e, t) => {
            ...
            return (
              await i.load(),
              await i.loadLanguage("osd"),
              await i.initialize("osd"),
              i.detect(e).finally(async () => {
                await i.terminate();
              })
            );
          };
    ...
    W8hG: [
      function (require, module, exports) {
        ...
        const e = require("./createScheduler"),
          r = require("./createWorker"),
          t = require("./Tesseract"),
          u = require("./constants/OEM"),
          i = require("./constants/PSM"),
          { setLogging: o } = require("./utils/log");
        module.exports = {
          OEM: u,
          PSM: i,
          createScheduler: e,
    ...
    Tgps: [
      function (require, module, exports) {
        ...
        var e = [
          ...
          { value: "ukr", text: "Українська" },
          { value: "eng", text: "English" },
          { value: "deu", text: "Deutsch" },
          { value: "fra", text: "Français" },
        ];
        exports.langs = e;
      },
      {},
        ...
        function t(t) {
          ...
          return {
            ...
            updateProgress: function (e, a) {
              s.status || t.appendChild(s.el),
                e !== s.status && (s.status = e),
                (s.progress = a);
            },
        ...
        function t(t, n) {
          ...
          ["dragenter", "dragover", "dragleave", "drop"].forEach(function (n) {
            ...
            t.addEventListener(
              "dragleave",
              function (e) {
                (e.toElement && e.toElement !== t && t.contains(e.toElement)) ||
                  a();
              },
              !1
            ),
    ...
    OCl4: [
      function (require, module, exports) {
        module.exports = "template/dist/img/photo3.jpg";
      },
      {},
    ],
    A2T1: [
      function (require, module, exports) {
        ...
        var i = document.getElementById("start"),
          g = (0, r.Log)(document.getElementById("log"));
        function f(e, n) {
          return t.default
            .recognize(e, n, {
              logger: function (e) {
                // console.log("Progress:", e),
                g.updateProgress(e.status, e.progress);
              },
            })
            .then(function (e) {
